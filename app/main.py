...
from app.routes import user_routes, chat_routes, friend_routes, hobby_routes, gps_routes, static_routes
...
app.include_router(static_routes.router, prefix="/static")
